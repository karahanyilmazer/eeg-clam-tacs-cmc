...
def get_P_TARGET(raw):
    ...
    data_signal = raw.copy().filter(l_freq,h_freq, l_trans_bandwidth = 1, h_trans_bandwidth = 1)._data #alpha
    ...
    data_broad = raw.copy().filter(1,30, l_trans_bandwidth = 1, h_trans_bandwidth = 1)._data
...
bads = ['P2','PO4', 'P4','AF4','F2','F4','O2','C5','O1','F10','TP9','F7','FT10','T8']
...
root = tk.Tk()
root.withdraw()
folder_path = filedialog.askdirectory(initialdir = "C:\\Users\\David\\Documents\\Closed-Loop-amtACS-Validation\\Data\\12_05_22")
